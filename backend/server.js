...
//login routes
//Register route (registering new user)
server.post("/register", async (request, response) => {
    ...
    try {
        ...
        response.status(500).send({ message: "User already exists, choose a different username" });
    }
});

//Login existing user route //relevant to assignment
